...
import { aboutLinks, footerLinks, serviceLinks, socialLinks } from "./data";

export default function Footer() {
  return (
    <footer className='bg-gray-100 lg:px-10 lg:py-5 md:px-5 px-1 py-2 text-gray-800 border-t border-gray-200'>
      ...
      <div className='border-t border-gray-200 mt-6 py-4'>
        <div className='container mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-4'>
          ...
          {/* Copyright */}
          <p className='text-sm font-extralight text-zhaket-secondary/50'>
