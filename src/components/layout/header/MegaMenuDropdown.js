              ...
              return (
                <li key={child._id}>
                  <div
                    ...
                    className={`flex items-center relative justify-start gap-3 rounded-md px-[15px] xl:px-[19px] py-3 xl:py-4 hover:bg-white hover:shadow-[0px_2px_8px_0px_rgba(73,75,84,0.05)] cursor-pointer transition-all duration-200 ${isActive ? "bg-white shadow-sm text-[#FF9606]" : "text-[#5B5C60]"}`}
                  >
        ...
        <div className="flex-1 min-w-0">
          <div className="grid w-full grid-cols-3 p-[30px]">
            <div className="flex col-span-2 items-start justify-between">
              {(() => {
                const activeChildId = activeMegaMenuTab[menu._id] || menu.children[0]?._id;
                        ...
                        <li key={subChild._id}>
                          <div>
                            <p
                              ...
                              className="transition duration-300 text-sm leading-7 pb-3 text-[#76767C] hover:text-[#ff9606]"
                            >
