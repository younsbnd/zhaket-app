...
const ProductFAQSection = ({ faqs }) => {
  ...
  if (!sortedFaqs || sortedFaqs.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-12">
        <BsQuestionCircle className="mb-4 text-6xl text-gray-300" />
        <p className="text-center text-lg text-[#76767C]">
  ...
  return (
    <div className="text-right bg-white md:px-6 md:pt-3 md:pb-6 p-2.5 rounded-md">
