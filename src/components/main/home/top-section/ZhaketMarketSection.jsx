...
import SearchModal from "@/components/layout/header/searchbox/Searchbox";
  ...
  return (
    <>
      <div className="p-2 space-y-8 self-center">
        ...
        {/* search */}
        <div 
          className="flex items-center rounded-md border-athens-gray p-1 transition duration-100 border-0 bg-white h-[60px] w-full max-w-[400px] md:max-w-[465px] shadow-[0px_5px_25px_0_rgba(126,137,155,0.12)] cursor-pointer"
        ...
        >
          ...
          <button 
            type="button"
            className="font-semibold cursor-pointer flex items-center justify-center gap-[10px] text-white transition duration-300 focus:outline-hidden focus:outline-0 h-12 px-5 py-4 text-sm bg-[#FF9606] hover:bg-[#FFE6C0] hover:text-[#B47510] rounded-md"
          >
